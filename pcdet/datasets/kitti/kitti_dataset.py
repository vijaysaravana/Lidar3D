...
class KittiDataset(DatasetTemplate):
    ...
    def generate_prediction_dicts(self, batch_dict, pred_dicts, class_names, output_path=None):
        ...
        def generate_single_sample_dict(batch_index, box_dict):
            ...
            # print(f'pred boxes camera :: {pred_boxes_camera}')
            pred_boxes_img, corners_points = box_utils.boxes3d_kitti_camera_to_imageboxes(
            ...
            pred_dict['corners_points'] = corners_points
        ...
        for index, box_dict in enumerate(pred_dicts):
            ...
            if output_path is not None:
                ...
                with open(cur_det_file, 'w') as f:
                    ...
                    corners_points = single_pred_dict['corners_points']
                    ...
                    #         print(f'qs[i, 0] : {qs[i, 0]}')
                    #         cv2.line(frame, (qs[i, 0], qs[i, 1]), (qs[j, 0], qs[j, 1]), color, thickness)
        ...
        return annos, frame, corners_points if output_path is not None else None
    ...
    def evaluation(self, det_annos, class_names, **kwargs):
        ...
        # print(f'Eval det_annos :: {eval_det_annos}')
        # print(f'Kitti infos annos :: {eval_gt_annos}')
